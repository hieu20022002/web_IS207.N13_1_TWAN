...
<body>
    ...
    <div class="grid-container">
        <div> 
            ...
            <div>Manyo Factory Pure & Deep Cleansing Soda Foam 100ml
            </div>   
        ...
        <div> 
            <img src="../Images_Web/Products/Cocoon/Bộ sản phẩm Cocoon.jpg" class="image-product" />
            <div>
                Tên sản phẩm
            </div>
            <div id="icon-thongke2">
        ...
        <div> 
            <img src="../Images_Web/Products/Cocoon/Bộ sản phẩm Cocoon.jpg" class="image-product" />
            <div>
            Manyo Factory Pure & Deep Cleansing Soda Foam 100ml  Manyo Factory Pure & Deep Cleansing Soda Foam 100ml
            </div> 
            <div id="icon-thongke2">
                <button class="material-symbols-outlined" id="icon">
                autorenew
